...
import VideoComment from "../Comments/VideoComments.jsx";
...
function VideoDetails({ video, notify }) {
  ...
  <div className="relative flex flex-col shadow-lg h-full my-3">
    ...
    <div className="flex justify-between items-center w-full h-[78px] border-t border-gray-400 mt-4 px-4 py-2">
      <div className="flex items-center">
        {owner ? (
          <>
            <Link to={`/profile/${owner?.username}`} className="flex items-center">
              <img
              ...
              />
              <div>
                <div className="font-medium hover:text-gray-300">
